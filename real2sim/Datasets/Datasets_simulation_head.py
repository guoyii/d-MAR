...
LastEditTime: 2022-11-17 21:33:10
LastEditors: GuoYi
'''
import pdb
import os
...
class BasicRealData(Dataset):
    def __init__(self, dataRootPath):
        self.pathList = findFiles(dataRootPath + '/*.mat')
...
class BuildRealDataSet(Dataset):
    def __init__(self, dataRootPath, preTransImg):
        self.preTransImg = preTransImg
        self.imgset = BasicRealData(dataRootPath)
