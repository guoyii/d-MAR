...
LastEditors: GuoYi
LastEditTime: 2023-05-31 21:05:56
...
import argparse
import inspect
from improved_diffusion.script_util_v1_fft import create_model_and_diffusion 
...
def train_defaults():
    ...
    default = dict(
        ...
        train_folder = {'kernel_list':[], 'thick_list':[], 'manu_list':[], 'kVp_list':[], 'mA_list':[], 'position_list':['Chest', 'Abdomen'], 'dataset_name':'normal'},
        test_folder = {'kernel_list':[], 'thick_list':[], 'manu_list':[], 'kVp_list':[], 'mA_list':[], 'position_list':['Chest', 'Abdomen'], 'dataset_name':'normal'},
        val_folder = {'kernel_list':[], 'thick_list':[], 'manu_list':[], 'kVp_list':[], 'mA_list':[], 'position_list':['Chest', 'Abdomen'], 'dataset_name':'normal'}
    )
